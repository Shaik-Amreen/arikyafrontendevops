...
@Component({
  selector: 'app-studentbacklog',
  templateUrl: './studentbacklog.component.html',
  styleUrls: ['./studentbacklog.component.css']
})
export class StudentbacklogComponent implements OnInit {
  ...
  //     headers: ['ROLL NUMBER', "Ongoing backlogs", "Total backlogs"],
  //     backAlpha: 'E3'
  //   }
