...
@Component({
  selector: 'app-overallcodequiz',
  templateUrl: './overallcodequiz.component.html',
  styleUrls: ['./overallcodequiz.component.css']
})
export class OverallcodequizComponent implements OnInit {
