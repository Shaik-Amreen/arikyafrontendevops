...
@Component({
  selector: 'app-campusplacementreports',
  templateUrl: './campusplacementreports.component.html',
  styleUrls: ['./campusplacementreports.component.css']
})
export class CampusplacementreportsComponent implements OnInit {
