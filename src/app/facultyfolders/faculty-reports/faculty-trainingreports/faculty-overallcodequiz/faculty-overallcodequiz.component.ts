...
@Component({
  selector: 'app-faculty-overallcodequiz',
  templateUrl: './faculty-overallcodequiz.component.html',
  styleUrls: ['./faculty-overallcodequiz.component.css']
})
export class FacultyOverallcodequizComponent implements OnInit {
