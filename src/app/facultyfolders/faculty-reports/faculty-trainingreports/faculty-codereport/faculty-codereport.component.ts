...
@Component({
  selector: 'app-faculty-codereport',
  templateUrl: './faculty-codereport.component.html',
  styleUrls: ['./faculty-codereport.component.css']
})
export class FacultyCodereportComponent implements OnInit {
  nodata: any = false
  stdseachtest: any;
  overallcodedata: any;
  topics: any;
