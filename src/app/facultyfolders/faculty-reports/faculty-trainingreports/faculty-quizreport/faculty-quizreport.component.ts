...
@Component({
  selector: 'app-faculty-quizreport',
  templateUrl: './faculty-quizreport.component.html',
  styleUrls: ['./faculty-quizreport.component.css']
})
export class FacultyQuizreportComponent implements OnInit {
