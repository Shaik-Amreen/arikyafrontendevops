...
@Component({
  selector: 'app-faculty-campusplacementesreports',
  templateUrl: './faculty-campusplacementesreports.component.html',
  styleUrls: ['./faculty-campusplacementesreports.component.css']
})
export class FacultyCampusplacementesreportsComponent implements OnInit {
