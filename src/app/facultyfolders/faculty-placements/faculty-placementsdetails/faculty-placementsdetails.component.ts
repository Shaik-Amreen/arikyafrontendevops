...
@Component({
  selector: 'app-faculty-placementsdetails',
  templateUrl: './faculty-placementsdetails.component.html',
  styleUrls: ['./faculty-placementsdetails.component.css']
})

export class FacultyPlacementsdetailsComponent implements OnInit {
  // @Directive({
  //   selector: '[ngVar]'
  // })
  ...
  setstatus() {
    ...
    this.router.navigate(["/faculty/placements/addeditplacements"])
  }
