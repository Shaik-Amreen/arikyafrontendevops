...
@Component({
  selector: 'app-faculty-companydetails',
  templateUrl: './faculty-companydetails.component.html',
  styleUrls: ['./faculty-companydetails.component.css']
})
export class FacultyCompanydetailsComponent implements OnInit {
            ...
            if (new Date(res.companydetails.deadline) < new Date() && res.companydetails.deadline != 'not updated') {
              ...
              this.commonservice.postrequest('http://localhost:4000/company/updatestatus', res.companydetails).subscribe(
                (response: any) => {
                  ...
                  this.companydetails.companylogo == '' ? this.companydetails.companylogo = "../../../../assets/user.png" : null;
  ...
  switchedit() {
    ...
    this.route.navigate(["/faculty/placements/addeditcompany"])
  }
