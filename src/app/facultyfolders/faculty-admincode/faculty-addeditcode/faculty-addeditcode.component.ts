...
@Component({
  selector: 'app-faculty-addeditcode',
  templateUrl: './faculty-addeditcode.component.html',
  styleUrls: ['./faculty-addeditcode.component.css']
})
export class FacultyAddeditcodeComponent implements OnInit {
