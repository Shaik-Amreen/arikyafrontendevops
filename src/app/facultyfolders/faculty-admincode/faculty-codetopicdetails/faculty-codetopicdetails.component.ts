...
@Component({
  selector: 'app-faculty-codetopicdetails',
  templateUrl: './faculty-codetopicdetails.component.html',
  styleUrls: ['./faculty-codetopicdetails.component.css']
})
export class FacultyCodetopicdetailsComponent implements OnInit {
  ...
  switchedit() {
    ...
    this.router.navigate(['/faculty/codequiz/code'])
  }
