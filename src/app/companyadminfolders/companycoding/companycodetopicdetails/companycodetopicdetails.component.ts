...
@Component({
  selector: 'app-companycodetopicdetails',
  templateUrl: './companycodetopicdetails.component.html',
  styleUrls: ['./companycodetopicdetails.component.css']
})
export class CompanycodetopicdetailsComponent implements OnInit {
  ...
  switchedit() {
    sessionStorage.setItem('editcodequiz', 'yes')
    this.router.navigate(['/admin/codequiz/code'])
  }
