...
@Component({
  selector: 'app-companyaddusers',
  templateUrl: './companyaddusers.component.html',
  styleUrls: ['./companyaddusers.component.css']
})
export class CompanyaddusersComponent implements OnInit {
  ...
  formdata: any[] =
    [
      { "label": "Email address", "formname": "mail", "value": "", "valid": true, "tags": "input", "type": "email", "placeholder": "Enter new user mail", "icon": 'bx bxs-envelope', 'pattern': "^[a-zA-Z0-9._%+-]+@mits+\.ac+\.in$", "patternerror": "invalid mail" },
