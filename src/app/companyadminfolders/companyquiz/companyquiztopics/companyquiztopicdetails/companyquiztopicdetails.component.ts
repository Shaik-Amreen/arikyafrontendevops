...
@Component({
  selector: 'app-companyquiztopicdetails',
  templateUrl: './companyquiztopicdetails.component.html',
  styleUrls: ['./companyquiztopicdetails.component.css']
})
export class CompanyquiztopicdetailsComponent implements OnInit {
  ...
  switchedit() {
    ...
    this.router.navigate(['/admin/codequiz/quiz'])
  }
