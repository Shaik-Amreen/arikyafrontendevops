...
@Component({
  selector: 'app-placementsalldetails',
  templateUrl: './placementsalldetails.component.html',
  styleUrls: ['./placementsalldetails.component.css']
})
export class PlacementsalldetailsComponent implements OnInit {
