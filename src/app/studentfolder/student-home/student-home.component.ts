...
export class StudentHomeComponent implements OnInit {
  ...
  constructor(private router: Router, private http: HttpClient, private commonservice: CommonService) {
    ...
    //   (res: any) => {
    // console.log(res);
    this.commonservice.postrequest('/Studentdata/studentplacementinterest', { organisation_id: sessionStorage.getItem("organisation_id"), mail: sessionStorage.getItem('mail'), query2: "placementstatusmails" }).subscribe(
      (response: any) => {
